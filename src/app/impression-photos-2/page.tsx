...
export default function ImpressionPhotos2() {
    ...
    <main className={styles.screen}>
      ...
      <div className={styles.card} id="main-content">
        ...
        <div className={styles.photoGrid}>
          {/* Upper Impression 1 — done state */}
          <Image
            src="/assets/images/imp-upper-1-done.svg"
            ...
            unoptimized
          />
          {/* Upper Impression 2 — links to next */}
          <div className={styles.photoCard} style={{ cursor: 'pointer' }} onClick={() => navigate('/impression-photos-3', 'forward')}>
            <div className={styles.photoCardInner}>
              <Image src="/assets/images/imp-tray-upper-2.svg" alt="" width={44} height={50} className={styles.trayImg} unoptimized />
            </div>
            <div className={styles.plusBadge}>
              <Image src="/assets/images/imp-icon-plus-new.svg" alt="" width={10} height={10} unoptimized />
            </div>
            <p className={styles.photoLabel}>Upper Impression 2</p>
            <p className={styles.photoSub}>Angle 2</p>
          </div>
        </div>
        ...
        <div className={styles.photoGrid}>
          {LOWER.map(slot => (
            <div key={slot.id} className={styles.photoCard} style={{ cursor: 'pointer' }} onClick={() => navigate('/impression-photos-3', 'forward')}>
              <div className={styles.photoCardInner}>
