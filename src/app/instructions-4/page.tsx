...
export default function Instructions4() {
  ...
  return (
    <main className={styles.screen}>
      ...
      <svg className={styles.progressBar} viewBox="0 0 395 5" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Instructions step 4" role="progressbar">
        ...
        <rect x="62"  width="302" height="5" rx="2.5" fill="#0E184D"/>
      ...
      <Image
        src="/assets/images/instructions-card-4.svg"
