...
export default function Instructions3() {
  ...
  return (
    <main className={styles.screen}>
      ...
      <svg className={styles.progressBar} viewBox="0 0 395 5" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Instructions step 3" role="progressbar">
        ...
        <rect x="62"  width="219" height="5" rx="2.5" fill="#0E184D"/>
      ...
      <Image
        src="/assets/images/instructions-card-3.svg"
      ...
      <div className={styles.bottomNav}>
        <button className={styles.btnBack} aria-label="Previous" onClick={() => navigate('/instructions-2', 'backward')}>
          <Image src="/assets/images/instructions-btn-back.svg" alt="Back" width={56} height={56} unoptimized />
        </button>
        <button className={styles.btnNext} aria-label="Next" onClick={() => navigate('/instructions-4', 'forward')}>
