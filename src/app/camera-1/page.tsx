...
const DEMO_PHOTO = "/assets/images/close-bite-right.png";
  ...
  const captureAndAnalyze = async () => {
    ...
    try {
      const res = await fetch("/api/analyze-photo", {
        ...
        body: JSON.stringify({ imageBase64: base64, photoType: "close-bite-side" }),
      });
  ...
  return (
    <main className={styles.screen}>
      ...
      <IntakeHeader
        label="Teeth Photos"
        pct={50}
        counter="Photo 2 of 4"
        onBack={() => navigate('/camera', 'backward')}
      ...
      <div className={styles.card} id="main-content">
        ...
        <div className={styles.cardHeader}>
          <div className={styles.cardHeaderText}>
            <h1 className={styles.cardTitle}>Mouth open</h1>
            <p className={styles.cardSubtitle}>
              {state === "idle" && "Open wide so we can see both your upper and lower teeth."}
